...
public class Carte {
    ...
    public void ajouteStation(String codeStation, String name, String arrondissement, String bonus, String is_renting, int capacite, int velo_disp, int emplacement_disp, String date) {
        mesStations.add(new Station(codeStation, name, arrondissement, bonus, is_renting, capacite, velo_disp, emplacement_disp, date));
    }
